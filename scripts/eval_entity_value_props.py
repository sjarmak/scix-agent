...
class SpecificEntityBackend:
    ...
    def _resolve_entity_id(self, name: str, *, entity_type: str | None = None) -> int | None:
...
def render_report(
    ...
    *,
    ...
    lines.append("")
    lines.append(f"_Generated by `scripts/eval_entity_value_props.py` on {run_timestamp}._")
    lines.append("")
