...
Writes ``contract/scix_mcp_v<CONTRACT_VERSION>.json`` (tool names, input and
successful-result schemas, the closed error-code catalog, and the response-
envelope shape). Run this after an *intentional* change to the MCP tool surface;
