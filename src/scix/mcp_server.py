...
# ---------------------------------------------------------------------------
# Legacy / inline handlers extracted from the former _dispatch_consolidated
# if-chain so every tool routes through the single _HANDLER_REGISTRY below.
# ---------------------------------------------------------------------------
...
# Single source of truth for tool -> handler routing. Replaces the former
# ~34-branch ``if name == ...`` chain in :func:`_dispatch_consolidated` that had
# to be hand-synced with EXPECTED_TOOLS and _DEPRECATED_ALIASES. health_check
# takes only the connection, so it is adapted to the (conn, args) handler shape.
_HANDLER_REGISTRY: dict[str, Callable[[psycopg.Connection, dict[str, Any]], str]] = {
    "find_similar_by_examples": _handle_removed_find_similar,
    "search": _handle_search,
    "lit_review": _handle_lit_review,
    "concept_search": _handle_concept_search,
    "get_paper": _handle_get_paper,
    "read_paper": _handle_read_paper,
    "citation_traverse": _handle_citation_traverse,
    "citation_graph": _handle_citation_graph,
    "citation_chain": _handle_citation_chain,
    "citation_similarity": _handle_citation_similarity,
    "entity": _handle_entity,
    "entity_context": _handle_entity_context,
    "graph_context": _handle_graph_context,
    "find_gaps": _handle_find_gaps,
    "temporal_evolution": _handle_temporal_evolution,
    "facet_counts": _handle_facet_counts,
    "claim_blame": _handle_claim_blame,
    "forward_citations": _handle_forward_citations,
    "find_replications": _handle_find_replications,
    "cited_by_intent": _handle_cited_by_intent,
    "claim_search": _handle_claim_search,
    "synthesize_findings": _handle_synthesize_findings,
    "section_retrieval": _handle_section_retrieval,
    "read_paper_claims": _handle_read_paper_claims,
    "find_claims": _handle_find_claims,
    "chunk_search": _handle_chunk_search,
    "add_to_working_set": _handle_add_to_working_set,
    "get_working_set": _handle_get_working_set,
    "get_session_summary": _handle_get_session_summary,
    "clear_working_set": _handle_clear_working_set,
    "get_citation_context": _handle_get_citation_context,
    "get_author_papers": _handle_get_author_papers,
    "health_check": lambda conn, args: _handle_health_check(conn),
    "entity_profile": _handle_entity_profile,
}
