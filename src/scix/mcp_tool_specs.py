...
_TOOL_SPECS: tuple[dict[str, Any], ...] = (
    ...
    dict(
        ...
        description=(
            ...
            "the intent axis is sparse (~0.27% of citation edges; ~825K contexts "
            "across 30K source / 250K cited papers). Intent responses always include "
            "coverage.contexts_available and coverage.total_edges for the requested "
            "paper, so an empty result distinguishes no matching intent from missing "
            "annotation data. Use "
